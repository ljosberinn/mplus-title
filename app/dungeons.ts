export const dungeonSlugMetaMap: Record<
  string,
...
> = {
  ...
  "grim-batol": { name: "Grim Batol", icon: "achievement_dungeon_grimbatol" },
  ...
  neltharus: { name: "Neltharus", icon: "achievement_dungeon_neltharus" },
